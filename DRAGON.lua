...
if res ~= 200 then
print('\27[0;31m♧═───═𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔═───═♧\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na♧═───═𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔═───═♧\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m♧═───═𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔═───═♧\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1955005482,05684,5241368,30,50}   
...
var = true
elseif tonumber(user_id) == tonumber(05684) then
var = true
elseif tonumber(user_id) == tonumber(30) then
var = true
elseif tonumber(user_id) == tonumber(5241368) then
var = true
...
if tonumber(user_id) == tonumber(1955005482) then  
var = 'ماب سفاح دمياط وقريب عمو شوقي نجار باب وشباك بس ايشخ 😂🕊'
elseif tonumber(user_id) == tonumber(05684) then
var = 'ماب سفاح دمياط وقريب عمو شوقي نجار باب وشباك بس ايشخ 😂🕊'
elseif tonumber(user_id) == tonumber(5241368) then
var = 'مطور السورس'
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'سـفـاحـيـن دمـيـاط'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "mmff1/9012?single")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ♬ 𝐒𝐎𝐔𝐑𝐂𝐄 𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔 ♬")  
...
local mab_x2 = database:get(bot_id..'text:ch:user')
if mab_x2 then
send(msg.chat_id_, msg.id_,'['..mab_x2..']')
else
...
SourceDRAGONr = '♧بص يصحبي 💛.. \n♧انـا بـوت سـفـاحـين دمـياط 🕊.. \n♧انـا بـوت حمايه 🔰 وبـطلع الـكول اشغل اغاني 🔊 \n♧ومـفيش فـيا مـطورين عـشان حماية بارك 🧸…\n♧عـشان تضفني في رومك ونت مطمن اتبع الخطوات دي💛…↓\n♧اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع ←{ منشئ او المشرفين } بتفعيل فقط\n[♧معرف المطور '
end 
...
keyboard = {
{'ماب سفاح دمياط وقريب عمو شوقي نجار باب وشباك بس ايشخ 😂🕊','مالك السورس'},
{'♧═───═𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔═───═♧'},
...
send(msg.chat_id_, msg.id_,' ♧ اصدار سورس سـفـاحـيـن دمـيـاط { s: 6.7}')
end
if text == 'بوت الاغاني' or text == 'المبرمج عبدو' or text == 'عبدو ماب سفاح دمياط وقريب عمو شوقي نجار باب وشباك بس ايشخ 😂🕊' or text =='عبدو خيري' then
local Text =[[


• ودي اوامر بوت الاغاني 💛..
...
{
{text = '𝗠𝗔𝗕 𝗠𝗨𝗦𝗜𝗖 𐇑', url = "https://t.me/UxU_M"},
},
{
{text = '𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔', url = "https://t.me/mmff1/9012?single"},
},
}
...
if text == 'جاكسون' or text == 'المطور جاكسون' or text == 'ماب مطور السورس' or text =='تيرارارار' then
local Text =[[
...
{
{text = '𝐃𝐞𝐯 𝐽𝐴𝑋𝑆𝑂𝑁', url = "https://t.me/UxU_M"},
},
{
{text = '𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔', url = "https://t.me/mmff1/9012?single"},
},
...
if text == 'ماب' or text == 'المبرمج ماب' or text == 'ماب ماب سفاح دمياط وقريب عمو شوقي نجار باب وشباك بس ايشخ 😂🕊' or text =='الهقر' then
local Text =[[


للتواصل مع  ماب سفاح دمياط 💛 وقريب عمو شوقي نجار باب وشباك بس ايشخ 😂🕊
اتبع الازرار الاتيه♦️
...
{
{text = '𝙳𝙰𝚅 𝙼𝙰𝙱', url = "https://t.me/xO_mab_Ox"},
},
{
{text = '𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔', url = "https://t.me/mmff1/9012?single"},
},
...
if AddChannel(msg.sender_user_id_) == false then
local mmff1/9012?single = database:get(bot_id..'text:ch:user')
if mmff1/9012?single then
send(msg.chat_id_, msg.id_,'['..mmff1/9012?single..']')
else
...
usertext = '\n ♧ العضو ← ['..result.title_..'](t.me/'..(username or 'mmff1/9012?single')..')'
status  = '\n ♧ تم ترقيته مطور'
...
usertext = '\n ♧ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'mmff1/9012?single')..')'
status  = '\n ♧ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♧ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'mmff1/9012?single')..') \n ♧ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ♧ العضو : {["..data.first_name_.."](t.me/mmff1/9012?single)}\n ♧ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ♧ عذرا ← {["..data.first_name_.."](t.me/mmff1/9012?single)}\n ♧ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'سـفـاحـيـن دمـيـاط' or text == 'دمياط' or text == 'السورس' or text == 'source' or text == 'يا سورس' or text == 'OLIANO' then 
local msg_id = msg.id_/2097152/0.5  
local Text = [[ 
...
keyboard = {}  
keyboard.inline_keyboard = {
{{text = '☼︎𝙳𝙰𝚅 𝙼𝙰𝙱☼︎',url="t.me/xO_mab_Ox"},
{{text = '  ❨ 𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔 ❩ ',url="https://t.me/mmff1/9012?single"}}, 
}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/mmff1/9012?single&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard.inline_keyboard = { 
{{text = '☼︎𝙳𝙰𝚅 𝙼𝙰𝙱☼︎',url="t.me/xO_mab_Ox"}}, 
{{text = '☼︎𝗠𝗔𝗕 𝗠𝗨𝗦𝗜𝗖 ☼︎',url="t.me/UxU_M"}}, 
{{text = '❨ 𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔 ❩ ',url="t.me/mmff1/9012?single"}}, 
...
if text == 'help' or text == 'اوامر البوت' or text == 'عبدو ماب سفاح دمياط وقريب عمو شوقي نجار باب وشباك بس ايشخ 😂🕊' or text == 'عبدو خيري' then
local Text =[[
...
"تكلم عن نفسك", 
"ليه انت مش سالك", 
"ما هيا عيوب سورس سـفـاحـيـن دمـيـاط؟ ", 
"اخر كتاب قرآته", 
"روايتك المفضله ?", 
"اخر اكله اكلتها", 
"اخر كتاب قرآته", 
"ليه سـفـاحـيـن دمـيـاط جدع؟ ", 
"افضل يوم ف حياتك", 
"ليه مضيفتش كل جهاتك", 
"حكمتك ف الحياه", 
"لون عيونك", 
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس سـفـاحـيـن دمـيـاط ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس سـفـاحـيـن دمـيـاط ؟ ", 
"كم مره حبيت؟ ", 
...
local Text = [[ 
[CH](t.me/mmff1/9012?single)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ ♬ 𝐒𝐎𝐔𝐑𝐂𝐄 ♬  ❩', url="t.me/mmff1/9012?single"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '♧═───═𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔═───═♧' then
local Text = [[ 
♬من أحسن السورسات على التليجرام سورس سـفـاحـيـن دمـيـاط♬
...
-- if text == 'ماب سفاح دمياط وقريب عمو شوقي نجار باب وشباك بس ايشخ 😂🕊' then
-- local Text = [[ 
-- [𝑯𝑨𝑹𝑾𝑬𝑵](t.me/mhzon1)
-- ]] 
-- keyboard = {}  
...
if text == 'العاب سـفـاحـيـن دمـيـاط' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ♬ اهلا في قائمه الالعاب المتطوره سورس سـفـاحـيـن دمـيـاط  ♬ 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ♧ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'mmff1/9012?single')..') \n ♧ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ♧ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'mmff1/9012?single')..') \n ♧ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(05684) then  
send(msg.chat_id_, msg.id_, " ♧ لا تسطيع حظر مالك السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(5241368) then  
...
if result.id_ == tonumber(05684) then
send(msg.chat_id_, msg.id_, " ♧ لا تسطيع حظر مالك السورس عام \n")
return false 
end
if result.id_ == tonumber(5241368) then
send(msg.chat_id_, msg.id_, " ♧ لا تسطيع حظر مطور السورس عام \n")
return false 
end
...
if tonumber(userid) == tonumber(05684) then  
send(msg.chat_id_, msg.id_, " ♧ لا تسطيع حظر مالك السورس عام")
return false 
end
if tonumber(userid) == tonumber(5241368) then  
send(msg.chat_id_, msg.id_, " ♧ لا تسطيع حظر مطور السورس عام")
return false 
end
...
t = ' ♧ ملفات السورس سـفـاحـيـن دمـيـاط ↓\n ♧═───═𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔═───═♧ \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n ♧ اهلا بك في متجر ملفات سـفـاحـيـن دمـيـاط\n ♧ ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\n♧═───═𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔═───═♧\n ♧ علامة تعني { ✔️ } ملف مفعل\n ♧ علامة تعني { ✖ } ملف معطل\n ♧ قناة سورس سـفـاحـيـن دمـيـاط ↓\n".." ♧ [اضغط هنا لدخول](t.me/mmff1/9012?single) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ♧ عذرا الملف لايدعم سورس سـفـاحـيـن دمـيـاط \n") 
end
return false
end
...
if text == ("مسح قائمه سـفـاحـيـن دمـيـاط") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ♧ تم مسح قائمه سـفـاحـيـن دمـيـاط')
return false
end

if text == 'قائمه سـفـاحـيـن دمـيـاط' and Sudo(msg) then
local list = database:smembers(bot_id..'CoSu'..msg.chat_id_)
t = "\n ♧ قائمه سـفـاحـيـن دمـيـاط \n♧═───═𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔═───═♧\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " ♧ لا يوجد احد في قائمه سـفـاحـيـن دمـيـاط"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع سـفـاحـيـن دمـيـاط") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local mmff1/9012?single = database:get(bot_id..'text:ch:user')
if mmff1/9012?single then
send(msg.chat_id_, msg.id_,'['..mmff1/9012?single..']')
...
if text and text:match("^رفع سـفـاحـيـن دمـيـاط @(.*)$") and Sudo(msg) then
local username = text:match("^رفع سـفـاحـيـن دمـيـاط @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local mmff1/9012?single = database:get(bot_id..'text:ch:user')
if mmff1/9012?single then
send(msg.chat_id_, msg.id_,'['..mmff1/9012?single..']')
...
if text and text:match("^رفع سـفـاحـيـن دمـيـاط (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع سـفـاحـيـن دمـيـاط (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local mmff1/9012?single = database:get(bot_id..'text:ch:user')
if mmff1/9012?single then
send(msg.chat_id_, msg.id_,'['..mmff1/9012?single..']')
...
if text == ("تنزيل سـفـاحـيـن دمـيـاط") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local mmff1/9012?single = database:get(bot_id..'text:ch:user')
if mmff1/9012?single then
send(msg.chat_id_, msg.id_,'['..mmff1/9012?single..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♧ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'mmff1/9012?single')..')'
status  = '\n ♧ تم تنزيله من سـفـاحـيـن دمـيـاط'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if text and text:match("^تنزيل سـفـاحـيـن دمـيـاط @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل سـفـاحـيـن دمـيـاط @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local mmff1/9012?single = database:get(bot_id..'text:ch:user')
if mmff1/9012?single then
send(msg.chat_id_, msg.id_,'['..mmff1/9012?single..']')
...
if text and text:match("^تنزيل سـفـاحـيـن دمـيـاط (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل سـفـاحـيـن دمـيـاط (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local mmff1/9012?single = database:get(bot_id..'text:ch:user')
if mmff1/9012?single then
send(msg.chat_id_, msg.id_,'['..mmff1/9012?single..']')
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ♧ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'mmff1/9012?single')..')'
status  = '\n ♧ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ♧ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ♧ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'mmff1/9012?single')..')'
...
' }\n'..' ♧  الايدي بالصوره ← { '..idph..
' }\n'..' ♧  الرفع ← { '..setadd..
' }\n'..' ♧  الحظر ← { '..banm..' }\n\n♧═───═𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔═───═♧\n ♧ قناة سورس سـفـاحـيـن دمـيـاط ↓\n [ ♬ 𝐒𝐎𝐔𝐑𝐂𝐄 𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔 ♬](t.me/mmff1/9012?single) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ♧ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'mmff1/9012?single')..')'..'\n ♧ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
cu = "سـفـاحـيـن دمـيـاط ،" else cu = "" end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♬ 𝐒𝐎𝐔𝐑𝐂𝐄 𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔 ♬.',url="t.me/mmff1/9012?single"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."mmff1/9012?single:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."mmff1/9012?single:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."mmff1/9012?single:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."mmff1/9012?single:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"♧تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."mmff1/9012?single:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."mmff1/9012?single:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس سـفـاحـيـن دمـيـاط يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سـفـاحـيـن دمـيـاط').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/mmff1/9012?single)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/mmff1/9012?single)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/mmff1/9012?single)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/mmff1/9012?single)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/mmff1/9012?single)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/mmff1/9012?single)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/mmff1/9012?single)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/mmff1/9012?single)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/mmff1/9012?single)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/mmff1/9012?single)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/mmff1/9012?single)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/mmff1/9012?single)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[علي فين يوسخ..🙂😹](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[طب انا بحبك يوه..💔🥺](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[بحبح اكتر ..🙂❤️](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ونا كان مين قالي ميسد ..🙂💔](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[شخصيه انت يعني ..🙂😹](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ قولي بحب الفضايح ..🙂😹](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ اومرني يقلبي ..❤️](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ كان نفسي ابقا محترم شبهك بس مجموعي مجبش ..😹🙂](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ هو مفكرني بني ادم ..😹🙂](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[يلا متجيش هنا تاني..😹🙂](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[انت الخير يعمري..🌚♥️](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عادي يتفلق هنعلمو اي يعني..💔😒](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وتسبني لمين طيب..💔🥺](t.me/mmff1/9012?single)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/mmff1/9012?single)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/mmff1/9012?single)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/mmff1/9012?single)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/mmff1/9012?single)') 
return false
end
end
end

if text == ""..(database:get(bot_id..'Name:Bot') or 'سـفـاحـيـن دمـيـاط').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سـفـاحـيـن دمـيـاط')
local DRAGON_Msg = {
'نعم يروحي😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'سـفـاحـيـن دمـيـاط')
local DRAGON_Msg = {
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'mmff1/9012?single')..')'
local iduser = result.sender_user_id_
...
اتبع الازرار تحت ⇣
واستمتع للأوامر 🕹️
♬[ 𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔 ](t.me/mmff1/9012?single)♬
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local Teext =[[
♧═───═𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔═───═♧
♬ بك في مميزات سورس سـفـاحـيـن دمـيـاط♬
♧═───═𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔═───═♧
♬ مميزات الخاصه بسورس ♬
♧═───═𝗗𝗔𝗠𝗜𝗘𝗧𝗧𝗔═───═♧
كت تويت ⇜ تويت 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سـفـاحـيـن دمـيـاط')
