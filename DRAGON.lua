...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ✯•━⌯━⌯━✯❴ᴍᴀᴛʀɪx❵✯━⌯━⌯ ━•✯ :\na✯•━⌯━⌯━✯❴ᴍᴀᴛʀɪx❵✯━⌯━⌯ ━•✯\n\27')
local token = io.read()
if token ~= '' then
...
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ✯•━⌯━⌯━✯❴ᴍᴀᴛʀɪx❵✯━⌯━⌯ ━•✯ :\na✯•━⌯━⌯━✯❴ᴍᴀᴛʀɪx❵✯━⌯━⌯ ━•✯\n\27[0;33;49m')
...
io.write('\27[1;31m ✯•━⌯━⌯━✯❴ᴍᴀᴛʀɪx❵✯━⌯━⌯ ━•✯ ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
if tonumber(user_id) == tonumber(2005704248) then  
var = 'المــبرمـج غـامــبول ♡'
elseif tonumber(user_id) == tonumber(1695549459) then
var = 'المـطور قـرصــان ♡'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'صـاحب البــوت يبشا ♡'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then
var = "المطور الثانوي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = 'البوت'
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼˹《♡ sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx ♡》˼")  
...
{
{text = 'معلومات ✯', callback_data="/change-hhh"},{text = 'السورس 𖤍', callback_data="/change-siusr"},
},
{
...
if text == 'الالـــعــاب' then
local Text = 'مرحبا بك ف قسم اللالعاب'
local Key = {
{'✯•━⌯━⌯━✯❴ᴍᴀᴛʀɪx❵✯━⌯━⌯ ━•✯'},
{'مطور','انا مين'},
{'انصحنى','كتبات'},
...
local Text = ' ✯تم ارسال الملصق من ✯•━⌯━⌯━✯❴ᴍᴀᴛʀɪx❵✯━⌯━⌯ ━•✯\n - '..Name
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/@G8_01/2107&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = 'قسم التفعيل والتعطيل'
local Key = {
...
local Text = 'قسم الحمايه للتحكم ف البوت'
local Key = {
...
local Name = 'مـطور البـوت للتـواصل اتـبع الازرار'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_, msg.id_,' ✯ اصدار سورس ماتريكس{ 1.0✓✯}')
end
if text == '✯•━⌯━⌯━✯❴ᴍᴀᴛʀɪx❵✯━⌯━⌯ ━•✯' and DevSoFi(msg) then
local Text = [[ 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/G8_01)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
send(msg.chat_id_, msg.id_, ' ✯ لا يوجد قناه بهذا المعرف')
return false  end
...
if text and text:match("^شهاب$") or text and text:match("^قرصان$") or text and text:match("^قرصان$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
if text and text:match("^غامبول$") or text and text:match("^غنبول$") or text and text:match("^مطور السورس$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᴅᴇᴠ sᴏᴜʀᴄᴇ♪ `', callback_data="/units"},{text = 'sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx♪ `', callback_data="/theytry"}},   
{{text = 'ᴅᴇᴠ ʙᴏᴛ', url="http://t.me/"..sudos.UserName}},
{{text = ' 𖤍 اضافه البوت لمجموعتك 𖤍' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'غامبول' or text == 'غنبول' or text == 'gambol' then
local Text = [[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ ɢᴀᴍʙᴏʟ 
...
if text == 'العاب ماتريكس' or text == 'العاب مطوره' or text == 'الالعاب المتطوره' then  
local Text = [[  
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'مــطور الــبوت للتـواصل معــاه 💕'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'G8_01')..')  ')
end,nil)   
end
...
send(msg.chat_id_, msg.id_, "✯ لا تسطيع حظر المبرمج غامبول")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1695549459) then  
send(msg.chat_id_, msg.id_, "✯ لا تسطيع  حظر المطور قرصان")
return false 
end
...
local Groups = database:scard(bot_id..'Chek:Groups')  
if AddChannel(msg.sender_user_id_) == false then
local G8_01 = database:get(bot_id..'text:ch:user')
if G8_01 then
send(msg.chat_id_, msg.id_,'['..G8_01..']')
else
send(msg.chat_id_, msg.id_,'    \n  ✯ اشترك اولا بلقناه \n  ['..database:get(bot_id..'add:ch:username')..']')
...
if tonumber(result.sender_user_id_) == tonumber(2005704248) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع كتم المبرمج غامبول")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1695549459) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع  كتم المطور قرصان")
return false 
end
...
if tonumber(userid) == tonumber(2005704248) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع كتم المبرمج غامبو")
return false 
end
if tonumber(userid) == tonumber(1695549459) then  
send(msg.chat_id_, msg.id_, " ✯ لا تسطيع  كتم المطور قرصان")
...
usertext = '\n ✯ العضو ← ['..result.title_..'](t.me/'..(username or 'G8_01')..')'
status  = '\n ✯ تم كتمه عام من {'..Groups..'} مجموعه'
texts = usertext..status
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✯ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'G8_01')..')'
status  = '\n ✯ تم كتمه عام من {'..Groups..'} مجموعه'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✯ العضو ← '..userid..''
...
local json_file, res = https.request("https://github.com/Gambol00/Gambol00/main/File_Bot/"..file)
if res == 200 then
...
if text == ("مسح الماتريكس") and Sudo(msg) then
...
send(msg.chat_id_, msg.id_, t..'✯•━⌯━⌯━✯❴ᴍᴀᴛʀɪx❵✯━⌯━⌯ ━•✯\nاضغط علي الاسم ليتم نسخه\n✯•━⌯━⌯━✯❴ᴍᴀᴛʀɪx❵✯━⌯━⌯ ━•✯\n ')
end
...
send(msg.chat_id_,msg.id_, 'هيححح ايــوه جاااااي') 
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/@G8_01)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/@G8_01)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..✯♥️](t.me/@G8_01)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/@G8_01)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/@G8_01)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/@G8_01)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/@G8_01)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتاع الرخااص ...😂😜](t.me/@G8_01)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـققك .🥰❤️](t.me/@G8_01)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بف...😹😹](t.me/@G8_01)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..??](t.me/@G8_01)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/@G8_01)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..✯💕](t.me/@G8_01)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/@G8_01)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/@G8_01)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/@G8_01)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/@G8_01)')
return false
end
end
end
...
if text == 'رفع' or text == 'فشخ' then
Text = [[
تم رفع العضو بنجاح
اصبح الان مفشوخ اقصد مرفوع
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' ✯ هو دا الي ضافك يلا افشخه  ➠:'..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' ✯ انت دخلت م الرابط يصحبي متحورش') 
end
end,nil)
else
...
Text = ' ✯ تم تفعيل الطرد يلا غورو ف داهيه😹'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' ✯ بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد القمر 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
ᯓ 𝟔𝟔𝟔𖡋 #msgs  ✟ 
ᯓ 𝟔𝟔𝟔𖡋 #game ✟
ᯓ 𝟔𝟔𝟔𖡋 ❲☆[sᴏᴜʀᴄʀ ᴍᴀᴛʀɪx](t.me/G8_01)☆❳
]],
[[
 ✯𝐮𝐬𝐞𝐫 : #username 𖣬  
 ✯𝐦𝐬𝐠  : #msgs 𖣬 
...
𝟔𝟔𝟔 𖡋 #game  𖣰💞
𝟔𝟔𝟔 𖡋 #msgs  𖣰💞
𝟔𝟔𝟔 𖡋 ❲☆[sᴏᴜʀᴄʀ ᴍᴀᴛʀɪx](t.me/G8_01)☆❳
]],
[[
⌔➺: Msgs : #msgs - 🔹.
⌔➺: ID : #id - 🔹.
...
𝟓 𝟔 𖡻 #stast  ࿇🦄
𝟓 𝟔 𖡻 #id  ࿇🦄
𝟓 𝟔 𖡻 ❲☆[sᴏᴜʀᴄʀ ᴍᴀᴛʀɪx](t.me/G8_01)☆❳
]],
[[
༻┉𖦹┉┉𖦹┉┉𖦹┉┉𖦹┉༺
 |𝗜𝗗  ⁞ #id
...
{
{text = 'تـغير اللـغه ↺', callback_data="/help90"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{{text = '⌯القائمه الرئيسيه⌯', callback_data="/help7"}},
{{text = 'sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx', url="t.me/G8_01"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ ˹ᴍᴀᴛʀɪx˼',url="t.me/G8_01"},{text = 'ᴀʟʟ ғᴏʀ ɢᴀᴍʙᴏʟ',url="t.me/G8_M_L0"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بــوت الحمـــايــه ✯',url="t.me/G8_00_bot"}},
{{text = '✯𝙱𝙰𝙲𝙺↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◉ ᯓ ˹ʙᴀʀ ǫᴏʀsᴀɴ ࿐',url="t.me/TEAMELSHYATIN"}},
{{text = '✯𝙱𝙰𝙲𝙺↵', callback_data="/qors-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/botqors' then
local Teext =[[
ʙᴏᴛ ǫᴏʀsᴀɴ ғᴏʀ sᴀᴠᴇ
ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بــوت الحمـــايــه ✯',url="t.me/E_h_a_b_bot"}},
{{text = '✯𝙱𝙰𝙲𝙺↵', callback_data="/qors-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
local Teext =[[
╭━━━━━❲☆[sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx](t.me/G8_01)☆❳━━━━━╮
   [ᴛʜᴇ ʙᴇsᴛ ᴏғ ᴛʜᴇ ʙᴇsᴛ sᴏᴜʀᴄᴇ](t.me/G8_01)
 [sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx ɪs ғᴏʟ sᴀᴠᴇ](t.me/G8_01)
╰━━━━━❲☆[sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx](t.me/G8_01)☆❳━━━━━╯
]]
keyboard = {} 
keyboard.inline_keyboard = {
